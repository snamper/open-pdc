    ...
    <div class="uk-panel uk-panel-box uk-panel-box-secondary">
        <div class="uk-container-center" style="width: 100px;overflow: hidden;">
            ...
            <div class="uk-float-right uk-vertical-align-bottom uk-text-center" style="line-height: 23px;width: 100%;">
                ...
                <a href="" target="_blank"><button class="btn btn-primary" type="button">积分:<?php echo ($UserSystemData["money"]); ?></button></a>
            </div>
        </div>
        <!--上面是用户的一些信息-->
        ...
        <div class="uk-text-center"> <a href="<?php echo U('/Developer');?>">进入发布中心</a></div>
    </div>
</div>