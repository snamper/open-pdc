            ...
            <table class="uk-table uk-table-striped uk-table-hover">
                ...
                <?php if(is_array($ShopData)): foreach($ShopData as $key=>$Plug): ?><tr id="pl-<?php echo ($Plug["pid"]); ?>" style="">
						...
						<div class="uk-button-group">
                            <a class="uk-button uk-button-success" href="<?php echo U('/Developer/EditPlugin/', array('pid'=>$Plug['pid']));?>">编辑</a>
                            <a class="uk-button uk-button-danger" onclick="delplug('<?php echo ($Plug["pid"]); ?>')">删除</a>
                        </div>
                        </td>
