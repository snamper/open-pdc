    ...
    <div class="uk-width-large-8-10">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            ...
            <form onsubmit="return check(this)" class="uk-form uk-form-horizontal uk-container-center uk-width-large-5-10 uk-width-small-1-1" target="_blank" method="post" action="<?php echo U('Developer/atm');;?>">
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="form-h-it2">支付宝账户：</label>
                    <div class="uk-form-controls">
                        <input id="form-h-it2" placeholder="如果不填写我们将不受理" name="togive" type="text">
                    </div>
                </div>
                <div class="uk-form-row">
                    <label class="uk-form-label" for="form-h-it3">支付宝账户姓名：</label>
                    <div class="uk-form-controls">
                        <input id="form-h-it3" placeholder="支付宝账户姓名" name="name" type="text">
                    </div>
                </div>
                <small>目前只支持支付宝提现，请见谅。</small><br><br>
...
<script>
    function check(e){
        ...
        if(num<1){
            UIkit.notify('<i class="uk-icon-refresh uk-icon-circle" style="color: #ff1c04 ;"></i> 金额需要大于30元',{ status:'info',timeout:1000,pos:'bottom-right'});
            return false;
        }
    }
</script>
