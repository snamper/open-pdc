        ...
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
			...
			<form action="<?php echo U('/Developer/SubmitPlugin');?>" method="post" class="uk-form uk-width-large-1-1 uk-grid" id="PlugData">
				...
				<h2>插件名称：</h2>
					...
					<input name="title" type="text" placeholder="名称" class="uk-width-large-1-1 uk-form-large" />
					</div>
					<br>
			...
			<div class="uk-panel uk-panel-box uk-panel-box-secondary">
				...
				<div id="mode">
					<label class="radio-inline">
						<input type="radio" id="plustate-1" value="opensource" checked> 开源
					</label>
					<label class="radio-inline">
						<input type="radio" id="plustate-2" value="closesource"> 闭源
					</label>
				</div>
