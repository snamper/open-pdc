                    ...
                    <div class="uk-width-large-4-6 uk-width-medium-4-6 uk-width-small-1-1">
                        <div class="uk-panel">
                            ...
                            <h1 class="uk-text-center">
                                <a class="b" href="{：U('/Login')}">我已注册账号</a>
                            </h1>
                            <button onclick="javascript:window.location.href='<?php echo U('/Login');?>'" class="uk-button uk-button-large uk-button-success uk-width-1-1">立 即 登 录</button>
                            <div class="b20"></div>
                            <div class="uk-form-row">
