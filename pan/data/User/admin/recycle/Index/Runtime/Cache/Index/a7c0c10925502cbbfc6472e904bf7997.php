...
<div class="uk-grid uk-margin-top uk-grid-small uk-margin-bottom">
    ...
    <div class="uk-width-large-8-10">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            <h3 class="uk-article-title">提现记录</h3>
            ...
            <table class="uk-table uk-table-striped uk-table-hover uk-form">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$record): ?><tr>
                        <td style="line-height: 27px;" class="uk-text-center"><?php echo ($record["mid"]); ?></td>
                        <td style="line-height: 27px;" class="uk-text-center"><span class="uk-button uk-button-primary"><?php echo ($record["number"]); ?></span></td>
                        <td style="line-height: 27px;" ><?php echo ($record["date"]); ?></td>
                        <td style="line-height: 27px;" ><?php echo ($record["note"]); ?></td>
                        <td style="line-height: 27px;" >
                            <?php switch($record['state']){ case '1'; echo '<i class="uk-icon-circle" style="color: #04ff70;">完成</i>'; break; case '2'; echo '<i class="uk-icon-circle" style="color: #ff0d00;">失败</i>'; break; default; echo '<i class="uk-icon-circle" style="color: #FFCA00;">进行中</i>'; break; } ?>
                        </td>
