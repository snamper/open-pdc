...
<div class="uk-grid uk-margin-top uk-grid-small uk-margin-bottom">
    ...
    <div class="uk-width-large-8-10">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            <h3 class="uk-article-title uk-float-left"><?php echo ($ActionTitle); ?> (如果没到帐请去支付宝确认收货)</h3>
            <div class="uk-float-right">
                <a href="<?php echo U('User/torecharge');;?>"><button class="uk-button uk-button-primary uk-button-large">我要充值！</button></a></div>
            ...
            <table class="uk-table uk-table-striped uk-table-hover uk-form">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$record): ?><tr>
                        <td style="line-height: 27px;vertical-align: middle;" class="uk-text-center"><?php echo ($record["aid"]); ?></td>
                        <td style="line-height: 27px;vertical-align: middle;" class="uk-text-center"><button class="uk-button uk-button-success"><?php echo ($record["price"]); ?></button></td>
                        <td style="line-height: 27px;vertical-align: middle;" ><?php echo ($record["adddate"]); ?></td>
                        <td style="line-height: 27px;vertical-align: middle;" ><?php echo ($record["title"]); ?></td>
                        <td style="line-height: 27px;vertical-align: middle;" >
                            <?php if($record['kadata']=='0'){ switch($record['state']){ case '1'; echo '<button class="uk-button uk-button-success"> 交易成功 </button>'; break; case '2'; echo '<button class="uk-button uk-button-danger"> 交易失败 </button>'; break; case '3'; echo '<button class="uk-button uk-button-danger"> 交易取消 </button>'; break; case '4'; echo '<a href="http://my.alipay.com/" target="_blank"><button class="uk-button uk-button-primary"> 点击收货 </button></a>'; break; default; echo '<a href="http://my.alipay.com/" target="_blank"><button class="uk-button"> 等待付款 </button></a>'; break; } }else{ switch($record['state']){ case '1'; echo '<button class="uk-button uk-button-success"> 交易成功 </button>'; break; case '2'; echo '<button class="uk-button uk-button-danger"> 交易失败 </button>'; break; default; echo '<button class="uk-button"> 正在充值 </button>'; break; } } ?>
                        </td>
