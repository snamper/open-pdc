    ...
    <div class="uk-width-large-8-10">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            ...
            <table class="uk-table uk-table-striped uk-table-hover">
                ...
                <?php if(is_array($ShopData)): foreach($ShopData as $key=>$Plug): ?><tr id="pl-<?php echo ($Plug["pid"]); ?>" style="">
						<td style="line-height: 27px;"><?php echo ($Plug["pid"]); ?></td>
                        <td style="line-height: 27px;"><?php echo ($Plug["title"]); ?></td>
						<td class="uk-text-right"><?php echo ($Plug['pluginstate']==1)?'正常':'审核中...'; ?></td>
                        <td class="uk-text-right"><div class="uk-badge"><?php echo ($Plug["downloads"]); ?></div></td>
                        <td class="uk-text-right">
						<div class="btn-group-vertical">
                            <a class="btn btn-success" href="<?php echo U('/Developer/EditPlugin/', array('pid'=>$Plug['pid']));?>">编辑</a>
							<a onclick="delplug('<?php echo ($Plug["pid"]); ?>')" class="btn btn-danger">删除</a>
							<?php
 if($Plug['avaliable'] != 1){ echo '<li><a pid="' . $Plug['pid'] . '" class="switch btn btn-primary" mode="1">下架</a></li>'; } else { echo '<li><a pid="' . $Plug['pid'] . '" class="switch btn btn-primary" mode="0">上架</a></li>'; } ?>
                        </div>
                        </td>
				...
				$('.switch').click(function(){
					var button = $(this);
					$.ajax({
						url: '<?php echo U('/Developer/CAvaliable');?>',
						async: true,
						type: 'POST',
						dataType: 'json',
